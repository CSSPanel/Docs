...
const Quickstart = () => {
	return (
		<>
			...
			<p className='text-base mb-10'>
				This is the most recommended way to run the panel, as it's the easiest, fastest way to get the panel up
				and running without much effort, and also connect it to a domain or subdomain with ssl easily.
				<br />
				<br />
				<b>Requirements:</b>
				<br />- Linux VPS with{' '}
			...
			<p className='text-base mb-10'>
				This is also a recommended way to run the panel as most of the communities are using Pterodactyl to host
				their game servers.
				<br />
				Note that the panel will run on the ip:port you will choose, and you can also connect a custom domain by
				defining a reverse proxy (listed below).
				<br />
				<br />
				<b>Requirements:</b>
				...
				<br />
				3. Create a new server using the egg, do not change the launch options if you don't know what you're
				doing.
				<br />
				...
				<br />
				6. The panel should create the `.env` file for you during the setup, if it didn't, create it manually
				and add the{' '}
				...
				Connect a custom domain to the panel, instead of using the server IP:Port you can define a nginx reverse
				proxy.
				<br />
				<Link
			...
			<h2 className='text-2xl'>- Option 3: Running on a VPS manually</h2>
			<p className='text-base mb-10'>
				This is the most advanced way to run the panel, as you will have to install everything manually
				<br />
				<br />
				...
				<br />
				8. The panel should create the `.env` file for you during the setup, if it didn't, create it manually
				and add the{' '}
				<Link href={`${process.env.NEXT_PUBLIC_REPO}/Panel/blob/main/.env.example`}>
					following environment variables
				</Link>{' '}
				and edit them accordingly.
				<br />
				9. The panel should be working now, you can connect a custom domain by defining a reverse proxy (more
				information below).
				<br />
				10. The panel should be running in the background, you can stop it using the following command: <br />
			...
			<h2 className='text-2xl'>- Option 4: Remote paid hosting</h2>
			<p className='text-base mb-10'>
				If you don't have a VPS or you are getting confused with the above options, you can get a remote hosting
				from us, we will host the panel for you and keep it up to date.
				<br />
